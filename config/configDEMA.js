...
const config = {
  ...
  getProperties: () => ({
    ...
    */
    ...
    dema_short: randomExt.integer(15,5),
    dema_long: randomExt.integer(31,15),
    dema_down: randomExt.float(-0.015,-0.035).toFixed(4),
    dema_up: randomExt.float(0.035,0.015).toFixed(4),
